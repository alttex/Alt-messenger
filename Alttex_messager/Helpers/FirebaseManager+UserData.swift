...
extension FirebaseManager {
    ...
    /**
     ...
     - parameters:
        - answer: on completion the escaping (Bool) value returns true or false based on wether the user has completed their account creation in the Database Database.
     */
    ...
    /**
     ...
     - parameters:
        - answer: on completion the escaping (Bool) value returns true or false based on wether the user has already created an account in the Database Database.
     */
